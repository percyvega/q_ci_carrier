...
import com.percyvega.q_ci_carrier.application.AttCarrierThread;
...
public class JMSReceiver implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            IntergateTransaction intergateTransaction = JacksonUtil.fromJson(msgText);
            logger.debug("JMS Message #" + ++count + ": " + intergateTransaction);
